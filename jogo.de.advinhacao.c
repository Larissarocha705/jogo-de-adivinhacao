...
//*definição do números de tentativas 
#define NUMERO_DE_TENTATIVAS 3 

int main() {

    //*Jogo de adivinhação de um número
    //! Irá chutar um número e ele irá informar se é menor ou maior que o número secreto , e se fosse acertou ou errou 
    //?também juntara o número sua pontuação para dizer quantos pontos você fez 
